...
class CompressedVQE:
    ...
    def get_solution_distribution(self,solution = 50):
        ...
        scatter = plt.scatter(c_norm, optimization_runs, c=fractions, cmap='viridis', marker='*', label='compressed')
    ...
    def optimize(self, n_measurements = 10000, number_of_experiments = 10, maxiter = 150):
        ...
        for k in range(number_of_experiments):
            ...
            print("Begin optimization for hardware efficient CompressedVQA and %.d measurments..." %(n_measurements))
            time1 = time.time()
